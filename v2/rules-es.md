...
* Las unidades aéreas deben terminar su movimiento en una Base Aérea, Portaaviones o Reabastecedor.
  * Si lo anterior no es posible, la unidad será destruida (excepto los reabastecedores). En ese caso, puede realizar un ataque kamikaze en la casilla en la que se encuentra contra cualquier unidad o complejo (según las reglas de los complejos).
...
*Note: Los elementos de infraestructura como carreteras, tuberías y puentes se destruyen con un solo impacto.*
...
* La infraestructura es completamente operativa (incluyendo tuberías, carreteras y puentes) en las casillas en disputa a menos que reciba daño.
  * Debe mantenerse durante un turno completo antes de ser productiva para el nuevo dueño.
...
* Un ataque preventivo se neutraliza si el ejército atacante también tiene al menos una unidad con ataque preventivo. In this case, the preemptive attack does not happen.
